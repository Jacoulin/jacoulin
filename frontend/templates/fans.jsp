...
<head>
    ...
    <link href="/dist/css/fans.css" rel="stylesheet">
        ...
        <div class="col-xs-12 col-sm-8 col-md-8 col-sm-offset-2 col-md-offset-2">
            <div id="num_bar">
                <div class="row">
                    ...
                    <div class="col-md-4 align_center">
                        <a class="btn_flag active" id="num_fans" href="/personal/${vid}/fans">
                            <span>0</span>
                            <span>粉丝</span>
                        </a>
                    </div>
...
<script type="text/javascript" src="/dist/js/fans.js"></script>
</body>
</html>
